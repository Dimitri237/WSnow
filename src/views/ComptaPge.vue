<template>
  ...
  <div class="page">
    ...
    <div v-for="(group, date) in groupedSales" :key="date" class="day-card">
      ...
      <div class="day-top">
        ...
        <div class="right">
          ...
          <button class="pdf-btn" @click="downloadPDF(date, group)">
            📄 Export PDF
          </button>
        </div>
      </div>
      ...
      <div class="table">
        ...
        <div v-for="sale in group.sales" :key="sale.id" class="table-row">
